...
image=PhotoImage(file="C:\\Users\\jtees\\Documents\\Python Files\\mood tracker\\yellow stars.png")
label.config(image=image,compound="left")
label.pack()
moods=["Happy","Sad","Angry","Nothing"]
happy=PhotoImage(file="C:\\Users\\jtees\\Documents\\Python Files\\mood tracker\\happy.png")
sad=PhotoImage(file="C:\\Users\\jtees\\Documents\\Python Files\\mood tracker\\sad.png")
angry=PhotoImage(file="C:\\Users\\jtees\\Documents\\Python Files\\mood tracker\\angry.png")
nothing=PhotoImage(file="C:\\Users\\jtees\\Documents\\Python Files\\mood tracker\\idk.png")
